...
class TestIntegrationTC2(object):
    ...
    @allure.title("Create a Booking, Delete the Booking with ID and Verify using GET request that it should not exist.")
    def test_integration_tc2(self, create_booking, create_token):
        ...
        get_response = get_request(url=APIConstants.url_get_booking(create_booking), auth=None)
